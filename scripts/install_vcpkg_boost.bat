...
rem ---------------------------------------------
rem [3] Install Boost via vcpkg
rem ---------------------------------------------
echo.
echo [2/4] Checking Boost installation...

set "BOOST_INCLUDE=!VCPKG_ROOT!\installed\x64-windows\include\boost"
if exist "!BOOST_INCLUDE!" (
    echo       Boost is already installed via vcpkg.
) else (
    ...
    echo       [OK] Boost installed successfully.
)
